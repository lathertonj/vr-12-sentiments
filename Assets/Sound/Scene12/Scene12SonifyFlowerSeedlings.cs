...
public class Scene12SonifyFlowerSeedlings : MonoBehaviour {
    ...
    public void StartChuck( float jumpDelay, System.Action launchASeedling, int numSeedlings )
    {
        ...
        myChuck.RunCode( string.Format( @"
            ...
            global int scene12HappyMode;
            false => global int scene12HappyFinishMode;
            ...
            {{
                ...
                while( true ) 
                {{
                    if( scene12HappyMode > currentGain )
                    {{
                        upSlew * ( scene12HappyMode - currentGain ) +=> currentGain;
                    }}
                    else
                    {{
                        downSlew * ( scene12HappyMode - currentGain ) +=> currentGain;
                    }}
