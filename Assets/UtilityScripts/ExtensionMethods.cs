...
public static class ExtensionMethods
{
    ...
    {
        return Mathf.Clamp( value.Map( inputFrom, inputTo, outputFrom, outputTo ), outputFrom, outputTo );
    }
    ...
    {
        return Mathf.Clamp( value.PowMap( inputFrom, inputTo, outputFrom, outputTo, pow ), outputFrom, outputTo );
    }
